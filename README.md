...
[![Rust](https://img.shields.io/badge/Rust-1.94+-orange.svg)](https://www.rust-lang.org/) [![License](https://img.shields.io/badge/License-GPL%202.0-blue.svg)](LICENSE) [![Windows](https://img.shields.io/badge/Windows-10%2B-green.svg)](https://www.microsoft.com/windows)
...
### 最新版本下载
- **TurboGitHub v0.0.2**：[下载链接](https://github.com/Gautown/TurboGitHub/releases/latest)
...
### v0.0.2 (最新)
- ✅ 新增 AO3 (Archive of Our Own) 访问支持
- ✅ 新增 Pixiv 访问支持
- ✅ 添加合规声明，明确使用规范和免责声明
- ✅ 优化 DNS 服务器域名检测逻辑
- ✅ 更新 HTTP 代理目标域名识别
- ✅ 更新 PAC 文件自动生成规则
- ✅ 修复 HTTP 代理 CONNECT 请求处理
- ✅ 修复 Linter 警告，提升代码质量
- ✅ 更新 Rust 版本要求至 1.94+
...
### 合法使用
- **仅供学习交流**：本项目仅供技术学习和研究使用，不得用于任何非法目的。
- **遵守法律法规**：使用本工具时，请确保遵守您所在国家/地区的相关法律法规。
- **尊重知识产权**：请尊重 GitHub 平台上所有开源项目的知识产权，遵守相应的开源许可证。

### 使用限制
- **禁止商业用途**：本工具为开源免费软件，禁止任何形式的商业销售或盈利行为。
- **禁止滥用**：请勿利用本工具进行网络攻击、恶意爬虫、数据窃取等滥用行为。
- **责任自负**：使用本工具所产生的后果由使用者自行承担，项目作者不承担任何法律责任。

### 技术说明
- **透明开源**：本项目完全开源，代码透明，接受社区监督。
- **本地运行**：所有功能均在本地运行，不会收集或上传任何用户数据。
- **无侵入性**：不修改系统核心文件，不影响其他应用程序的正常运行。

### 免责声明
- **按"原样"提供**：本工具按"原样"提供，不提供任何明示或暗示的保证。
- **技术风险**：使用本工具可能存在技术风险，请谨慎使用。
- **更新维护**：项目作者保留随时更新、修改或停止维护本项目的权利。
